...
class DinningTableRepository{
    ...
    async getDinningTableById(id){
        try {
            ...
            throw new Error({ codeError: 500, message: 'Internal error in search Dinning Table!' });
        }
    }
    ...
    async getDinningTableToDeviceId(id){
        try {
            ...
            throw new Error('Error in search Dinning Table');
        }
    }
    ...
    async create({ closed, deviceId }){
        try {
            ...
            throw new Error('Error in create the new dinningTable');
        }
    }
    ...
    async delete(id){
        try {
            ...
            throw new Error('Error in delete dinning');
        }
    }
}
